...
[![Go Report Card](https://goreportcard.com/badge/github.com/SamirIngley/go-makesite)](https://goreportcard.com/report/github.com/SamirIngley/go-makesite)
...
- [x] Add any third party library to your project to enhance it's functionality. Some ideas you might consider include **_(CHOOSE ONLY ONE)_**:
    ...
    - [x] **_FILL IN THE BLANK_**: `I will use the GoDotEnv library. The documentation is located at https://github.com/joho/godotenv. My goal is to use it to hide API Keys so I can use APIs !!`
- [x] **Add, commit, and push to GitHub**.
